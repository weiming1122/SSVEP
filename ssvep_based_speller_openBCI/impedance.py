...
channel_names = ['PO3', 'O1', 'unknown','unknown', 'Oz', 'PO4', 'O2', 'unknown'] # new device 
...
color_pos = [(200, 450), (275, 460), (350, 450), (190, 390), (360, 390)]
text_pos = [(190, 455), (265, 465), (340, 455), (175, 395), (345, 395)]
text_label = ['O1', 'Oz', 'O2', 'PO3', 'PO4'] 
imp_to_text_mapping = [1, 4, 6, 0, 5]

text_imp_pos = [(180, 480), (260, 490), (335, 480), (170, 370), (340, 370)]
# plot
...
def plot_impedence():
    while True:
        try:
            # text_imp_label = [k for i, k in enumerate(impedence) if channel_names[i] != 'unknown']
            text_imp_label = [impedence[i] for i in imp_to_text_mapping]
            text_imp_label = [k if k > 0 else 0 for k in text_imp_label]

            with Image.open('impedance_assets/head.png') as image_file:
